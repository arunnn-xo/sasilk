...
const DEFAULT_ANNOUNCEMENTS: AnnouncementData[] = [
  { id: 1, text: 'Shipping Worldwide', linkUrl: '', sortOrder: 1 },
  { id: 2, text: 'Easy Return & Exchange*', linkUrl: '', sortOrder: 2 },
  { id: 3, text: 'EMI Option Available*', linkUrl: '', sortOrder: 3 },
  { id: 4, text: 'Saving Scheme available*', linkUrl: '', sortOrder: 4 },
  { id: 5, text: 'Delivery Time: 1 - 3 Weeks', linkUrl: '', sortOrder: 5 },
]

export default function AnnouncementBar() {
  const [announcements, setAnnouncements] = useState<AnnouncementData[]>(DEFAULT_ANNOUNCEMENTS)
