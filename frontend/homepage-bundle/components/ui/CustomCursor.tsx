...
export default function CustomCursor() {
  ...
  useEffect(() => {
    ...
    const createGoldenParticle = (x: number, y: number) => {
      ...
      const goldColors = ['#D4AF37', '#C5A059', '#FDB931', '#E5C158', '#9c1a218DC']
  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        /* Permanent letter branding - White normally, transitions to gold on hover */
        .custom-cursor .letter-s {
          ...
          margin-top: -2px;
          pointer-events: none;
          text-shadow: 0 1px 2px rgba(0,0,0,0.85), 0 0 6px rgba(255, 255, 255, 0.4);
        ...
        .custom-cursor.hovering .letter-s {
          color: #FFD700;
          text-shadow: 0 1px 2px rgba(0,0,0,0.9), 0 0 10px rgba(255, 215, 0, 0.95);
        }
        ...
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <radialGradient id="heart3d" cx="30%" cy="30%" r="70%" fx="25%" fy="25%">
              <stop offset="0%" stopColor="#e8112c" />
              <stop offset="35%" stopColor="#c40017" />
              <stop offset="85%" stopColor="#8a0010" />
