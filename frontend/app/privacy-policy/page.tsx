...
export const metadata = {
  title: 'Privacy Policy | Soil Goddess',
}
      ...
      <main className="min-h-screen pt-28 pb-16 px-4 sm:px-6 lg:px-8" style={{ background: 'var(--ivory)' }}>
        <div className="mx-auto max-w-3xl bg-white p-6 sm:p-8 md:p-12 shadow-sm rounded-md border border-[var(--ivory-dark)]">
          ...
          <div className="space-y-4 sm:space-y-6 font-sans text-[var(--muted)] text-sm sm:text-base leading-relaxed font-medium">
            <p>
              At <strong>Soil Goddess</strong>, your privacy matters to us. We are committed to safeguarding your personal information and ensuring a secure shopping experience every time you visit our website.
            </p>
            
            <p>
              When you interact with Soil Goddess, we may collect basic information such as your name, contact details, shipping address, and payment information. This data helps us process your orders smoothly and keep you updated throughout your purchase journey.
            </p>
