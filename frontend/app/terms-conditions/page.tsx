      ...
      <main className="min-h-screen pt-28 pb-16 px-4 sm:px-6 lg:px-8" style={{ background: 'var(--ivory)' }}>
        <div className="mx-auto max-w-3xl bg-white p-6 sm:p-8 md:p-12 shadow-sm rounded-md border border-[var(--ivory-dark)]">
          ...
          <div className="space-y-4 sm:space-y-6 font-sans text-[var(--muted)] text-sm sm:text-base leading-relaxed font-medium">
            <p>
              Welcome to <strong>Soil Goddess</strong>.
            </p>
            ...
            <p>
              All products listed on our website are subject to availability. While we strive to display accurate information, Soil Goddess reserves the right to update product details, pricing, and availability at any time without prior notice.
            </p>
            ...
            <p>
              All content on this website, including images, logos, and text, is the property of Soil Goddess and may not be used without permission.
            </p>
