        ...
        <div className="mb-6 flex flex-col items-center justify-between rounded-lg border border-[#EFEBE4] bg-[#FDFBF9] p-5 shadow-sm sm:flex-row sm:p-8">
          <div className="mb-4 text-center sm:mb-0 sm:text-left">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 sm:justify-start">
              ...
              <span className="text-sm text-gray-500">
                {summary.average > 0 ? summary.average.toFixed(1) : 'No'} / 5
              </span>
          ...
          <div className="flex gap-2">
            ...
            {!session && summary.total > 0 ? (
              <a
                href="/login"
                className="rounded-full border border-gray-300 px-8 py-3 text-sm font-medium text-gray-600 transition hover:bg-gray-50"
              >
                Sign in to write a review
              </a>
            ) : null}
            {hasReviewed ? (
              <span className="inline-flex items-center gap-1.5 rounded-full bg-green-50 px-4 py-2.5 text-sm font-medium text-green-700">
        ...
        {loading ? (
          ...
          <div className="rounded-lg border border-dashed border-gray-300 py-10 text-center">
            ...
            {session ? (
              ...
              <a href="/login" className="mt-1 inline-block text-xs font-medium text-[#A34336] hover:underline">
                Sign in to write a review
              </a>
            )}
          </div>
