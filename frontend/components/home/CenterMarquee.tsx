...
export default function CenterMarquee() {
  ...
  return (
    <div className="relative overflow-hidden w-full py-6 md:py-10 my-4 md:my-8 shadow-2xl">
      ...
      <div className="absolute top-[4px] left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-[#E8C97E] to-transparent opacity-30" />
      ...
      <div className="absolute bottom-[4px] left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-[#E8C97E] to-transparent opacity-30" />
