...
export function FeaturesStrip() {
  ...
  return (
    <>
      {/* Top Peacock Border */}
      <div className="w-full h-6 md:h-7 bg-repeat-x opacity-90" style={{ backgroundImage: "url('/borderdesign/peacock-border.png')", backgroundSize: "contain", backgroundPosition: "bottom" }}></div>
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-0">
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="flex-shrink-0 w-14 h-14 rounded-full bg-burgundy border border-stone-200 flex items-center justify-center shadow-sm transition-transform duration-300 hover:scale-110">
                {feature.icon}
              </div>
              ...
              <div className="flex flex-col">
                ...
                <p className="text-gold text-[11px] md:text-sm mt-1 font-medium">
                  {feature.description}
                </p>
              </div>
            </div>
      ...
      {/* Bottom Peacock Border */}
      <div className="w-full h-6 md:h-7 bg-repeat-x opacity-90" style={{ backgroundImage: "url('/borderdesign/peacock-border.png')", backgroundSize: "contain", backgroundPosition: "top" }}></div>
    </>
  );
}
...
export function SubcatBar() {
  ...
  const [categories, setCategories] = useState([
    ...
    { name: 'Silk', img: '/categories/fabric/silk.png' },
    ...
    async function load() {
      try {
        ...
        if (data && data.length > 0) {
          setCategories([
            { name: 'All', img: '/categories/fabric/all.png' },
            ...data.map(c => ({ name: c.name, img: c.imageUrl })),
          ])
        }
      } catch {
        // keep defaults
  ...
  return (
    <div className="py-8 md:py-12 bg-[#FAF6EE] flex flex-col items-center px-4 font-sans overflow-hidden relative border-y border-[#D9B86E]">
      ...
      <div className="w-full max-w-7xl overflow-x-auto hide-scrollbar">
        <div className="flex gap-6 md:gap-10 lg:justify-center px-4 pb-6 min-w-max items-center">
...
export function CategoryGrid() {
  const [categories, setCategories] = useState<{ name: string; image: string; href: string }[]>([])

  useEffect(() => {
    async function load() {
      try {
        const data = await fetchCategories('featured')
...
export function SpotlightSection() {
  return (
    <section className="relative w-full bg-[#FAF6EE] overflow-hidden py-6 md:py-10">

      {/* Golden Floral Pillars — hidden on mobile, show md+ */}
      <div className="absolute left-0 top-0 h-full w-24 md:w-44 lg:w-60 pointer-events-none z-10 hidden md:block">
        <img src="/custom-pillar-transparent.png" alt="" className="w-full h-full object-contain object-left-top drop-shadow-xl" />
      </div>
      <div className="absolute right-0 top-0 h-full w-24 md:w-44 lg:w-60 pointer-events-none z-10 hidden md:block">
        <img src="/custom-pillar-transparent.png" alt="" className="w-full h-full object-contain object-right-top scale-x-[-1] drop-shadow-xl" />
      </div>
      ...
      <div className="max-w-[1200px] mx-auto relative z-0 px-2 sm:px-4 md:px-16 lg:px-24">
        <img
          ...
          className="w-full h-auto block object-cover rounded-xl shadow-[0_16px_40px_rgba(107,26,42,0.15)] border-2 md:border-4 border-gold"
        />
      </div>
    </section>
  )
...
export function HeritageSection() {
  return (
    <section className="py-10 md:py-16 relative text-center px-4 overflow-hidden bg-[#FAF6EE]">
      ...
      <div className="max-w-5xl mx-auto mb-6 md:mb-8 relative z-10">
...
export function LookbookSection() {
  ...
  return (
    <section className="relative border-t border-[#D9B86E] bg-[#FAF6EE]">
...
export function ArtWaveSection() {
  ...
  return (
    <section className="w-full bg-[#FAF6EE] pt-16 lg:pt-24 pb-16 lg:pb-24 relative overflow-hidden flex flex-col justify-center min-h-[500px] lg:min-h-[600px]">
      ...
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#C29B57] to-transparent opacity-40"></div>
      ...
      <div className="w-full max-w-[1400px] mx-auto px-4 lg:px-8 relative z-20">
        <div className="text-center mb-10 lg:mb-12">
          <div className="inline-flex items-center justify-center gap-2.5 mb-3">
            <span className="text-[#C29B57] opacity-80 text-xs">✦</span>
            <h3 className="font-cinzel text-[#C29B57] text-[11px] md:text-[12px] font-bold tracking-[0.3em] uppercase">
              Experience the Magic
            </h3>
            <span className="text-[#C29B57] opacity-80 text-xs">✦</span>
          </div>
          
          <h2 className="font-playfair text-[#8A1C22] text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-4">
            The <span className="font-cormorant italic font-normal text-[#B58C43]">Art</span> of Weaving
          </h2>
          
          <div className="flex items-center justify-center gap-3">
            <div className="h-[1px] w-16 bg-gradient-to-r from-transparent to-[#C29B57]"></div>
            <span className="text-[#8A1C22] text-sm">❖</span>
            <div className="h-[1px] w-16 bg-gradient-to-l from-transparent to-[#C29B57]"></div>
          </div>
        </div>
