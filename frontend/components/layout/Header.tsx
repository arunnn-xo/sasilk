                                ...
                                <div className="flex flex-wrap gap-2">
                                  {childCats.map(child => (
                                    <Link
                                      ...
                                      className="rounded-full border border-[#D9B86E]/60 bg-white px-4 py-1.5 text-[13px] font-semibold text-[var(--burgundy)] no-underline transition-all duration-300 hover:border-[var(--burgundy)] hover:bg-[var(--burgundy)] hover:text-[#FAF6EE]"
