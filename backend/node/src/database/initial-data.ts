...
// Mirrors `frontend/lib/data/navigation.ts` (STATIC_NAV_MENU).
// This is the single source for the header nav + admin category tree.
export const headerNavMenu: HeaderNavItem[] = [
  {
    name: 'ORGANIC SAREES',
    ...
    subCategories: [
      ...
      { name: 'KALAMKARI', href: '/collections/kalamkari', directLink: true },
      { name: 'KANCHIPURAM SILK', href: '/collections/kanchipuram', directLink: true },
      { name: 'MYSORE SILK', href: '/collections/mysore-silk', directLink: true },
      { name: 'BANARASI SILK', href: '/collections/banarasi-silk', directLink: true },
      { name: 'MODAL SILK', href: '/collections/modal-silk', directLink: true },
      { name: 'TUSSAR SILK', href: '/collections/tussar-silk', directLink: true },
      { name: 'PEN KALAMKARI SILK', href: '/collections/pen-kalamkari-silk', directLink: true },
      { name: 'PAITHANI SILK', href: '/collections/paithani-silk', directLink: true },
      { name: 'MULBERRY SILK', href: '/collections/mulberry-silk', directLink: true },
      { name: 'BANANA SILK (Chinnalampattu)', href: '/collections/banana-silk', directLink: true },
      { name: 'LOTUS SILK', href: '/collections/lotus-silk', directLink: true },
      { name: 'ERI SILK', href: '/collections/eri-silk', directLink: true },
      { name: 'MUGA SILK', href: '/collections/muga-silk', directLink: true },
      {
        name: 'PALUM PAZHAMUM',
      ...
      { name: 'SATIN', href: '/collections/satin', directLink: true },
      { name: 'HEMP', href: '/collections/hemp', directLink: true },
      {
        name: 'WOOL',
      ...
      { name: 'JUTE', href: '/collections/jute', directLink: true },
      {
        name: 'FANCY',
...
export const defaultBanners = [
  {
    ...
    ctaUrl: '/collections/organic-sarees',
  },
  {
