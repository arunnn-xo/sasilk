...
export const Order = sequelize.define('Order', {
  ...
  gatewayPaymentId: { type: DataTypes.STRING(120), allowNull: true, field: 'razorpay_payment_id' },
  gatewayOrderId: { type: DataTypes.STRING(120), allowNull: true, field: 'razorpay_order_id' },
