          ...
          <div className="mx-4 w-full max-w-2xl rounded-lg border border-[var(--line)] bg-white shadow-2xl">
            ...
            <div className="max-h-[70vh] overflow-y-auto p-6">
              ...
              <div style={{ maxWidth: 600, margin: '0 auto', background: '#ffffff', borderRadius: 8, overflow: 'hidden', border: '1px solid #e5e7eb' }}>
                {/* Header — logo area */}
                <div style={{ background: '#faf7f2', textAlign: 'center', padding: '24px 40px 8px' }}>
                  <span style={{ fontSize: 22, fontWeight: 700, color: '#4A0F1C', fontFamily: 'serif' }}>Threads of Tamil Nadu</span>
                </div>
                {/* Banner image */}
                {imageUrl && (
                ...
                <div style={{ padding: '36px 40px 20px' }}>
                  <p style={{ margin: '0 0 20px', color: '#4A0F1C', fontSize: 16 }}>
                  ...
                  <p style={{ margin: 0, color: '#555', fontSize: 14, lineHeight: 1.6 }}>
                    Thank you for being a valued member of the Threads of Tamil Nadu family.
                  </p>
                  <p style={{ margin: '16px 0 0', color: '#555', fontSize: 14, lineHeight: 1.6 }}>
                    Visit our store to explore more!
                  </p>
                  <div style={{ marginTop: 24, textAlign: 'center' }}>
                    <a href="#" style={{ display: 'inline-block', background: 'linear-gradient(135deg,#4A0F1C,#6B1A2A)', color: '#ffffff', padding: '14px 40px', borderRadius: 8, textDecoration: 'none', fontSize: 15, fontWeight: 700, letterSpacing: 1 }}>Visit Store →</a>
                  </div>
                </div>
                {/* Footer */}
                <div style={{ background: '#faf7f2', padding: '20px 40px', borderTop: '1px solid #e8dcc4', textAlign: 'center' }}>
                  <p style={{ margin: 0, color: '#999', fontSize: 11 }}>You received this email because you are a registered member of Threads of Tamil Nadu.</p>
                  <p style={{ margin: '6px 0 0', color: '#bbb', fontSize: 10 }}>Unsubscribe from marketing emails.</p>
                  <p style={{ margin: '2px 0 0', color: '#bbb', fontSize: 10 }}>&copy; {new Date().getFullYear()} Threads of Tamil Nadu. All rights reserved.</p>
                </div>
              </div>
            </div>
