...
export default function GuestDiscountPopupSettings() {
  ...
  if (isFetching) {
    return (
      <section className="bg-white rounded-2xl p-8 shadow-sm border border-[#EFE8DA]">
  ...
  return (
    <section className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-[#EFE8DA] space-y-6">
      <div className="flex items-center gap-4">
        <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#FBF7F8] text-[#6B1A2A] shadow-sm border border-[#D9B86E]/40">
          <Tag className="h-6 w-6" />
        </div>
        <div>
          <h2 className="text-xl font-black text-[#1F080D] tracking-tight">Guest Discount Popup</h2>
          <p className="text-sm text-[#7A6065] mt-0.5">Manage the registration discount popup shown to guest visitors.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleGuestPopupSubmit} className="rounded-2xl border border-[#EFE8DA] bg-[#FAF6EE]/50 p-6 space-y-5">
        <div className="space-y-5">
          <label className="flex items-center gap-3 cursor-pointer select-none">
            <input
              ...
              className="h-4.5 w-4.5 rounded border-slate-300 text-[#6B1A2A] focus:ring-[#6B1A2A]/20"
            />
            <span className="text-sm font-bold text-[#1F080D]">Enable Guest Discount Popup</span>
          </label>

          <div>
            <label className="mb-1.5 block text-xs font-bold text-[#7A6065] uppercase tracking-wider">Discount Percentage (%)</label>
            <input
              type="number"
              min="0"
              max="100"
              ...
              className="w-full max-w-xs rounded-xl border border-[#EFE8DA] bg-white px-3.5 py-2.5 text-sm text-[#1F080D] font-bold outline-none transition focus:border-[#6B1A2A] focus:ring-2 focus:ring-[#6B1A2A]/20"
            />
          </div>

          <div>
            <label className="mb-1.5 block text-xs font-bold text-[#7A6065] uppercase tracking-wider">Popup Message</label>
            <input
              type="text"
              ...
              className="w-full rounded-xl border border-[#EFE8DA] bg-white px-3.5 py-2.5 text-sm text-[#1F080D] font-semibold outline-none transition focus:border-[#6B1A2A] focus:ring-2 focus:ring-[#6B1A2A]/20"
            />
            ...
            <p className="mt-2 text-xs font-bold text-amber-700 bg-amber-50 px-3 py-1.5 rounded-lg inline-block border border-amber-200/60">Preview: {guestPopupPreview}</p>
